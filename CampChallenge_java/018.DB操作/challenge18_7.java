 ...
 * @author 44yos
 */
@WebServlet(urlPatterns = {"/challenge18_7"})
public class challenge18_7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String sql = "UPDATE profiles SET name='吉松枝美',tel='098-7654-3210',age=22,birthday=19960414 WHERE profilesID=5";
